...
carry_forward <- function(index, cat) {
  ...
  output <- main_all2 %>%
    ...
    filter(
      if (sex == "F") {
        age_wk < ((!!cat / 100) * life_exp_f$life_exp_wk + 1)
      } else {
        age_wk < ((!!cat / 100) * life_exp_m$life_exp_wk + 1)
      }
    ) %>%
    ...
    filter(
      if (sex == "F") {
        le_wk >= ((!!cat / 100) * life_exp_f$life_exp_wk)
      } else {
        le_wk >= ((!!cat / 100) * life_exp_m$life_exp_wk)
      }
    ) %>%
