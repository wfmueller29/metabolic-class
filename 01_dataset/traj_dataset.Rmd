...
output <- main_all2 %>% 
   ...
   filter(
     if (sex == "F") age_wk < ((!!cat/100)*life_exp_f$life_exp_wk + 1) 
     else age_wk < ((!!cat/100)*life_exp_m$life_exp_wk + 1) ) %>% 
   mutate(!!index_cat := !!index) %>% 
   #choose closest value
   filter(per_age_wk == max(per_age_wk)) %>% 
   #filter for those alive at timepoint 
   filter(
     if (sex == "F") le_wk >= ((!!cat/100)*life_exp_f$life_exp_wk) 
     else le_wk >= ((!!cat/100)*life_exp_m$life_exp_wk)) %>% 
...
#sex
slam_fig_i1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", 
...
slam_fig_i2 <- fcn_plotdist_smooth(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", 
                        y = "bw", ylabel = "Body Weight (g)", by = "sex", peak1 = bw_peak_male, peak2 = bw_peak_female) + 
  scale_color_manual(labels = c("Female", "Male"), name = "Sex", values = cbPalette_dot)
slam_fig_i3 <- fcn_plotdist_smooth(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy",
                        y = "fat", ylabel = "Body Fat (g)", by = "sex", peak1 = fat_peak_male, peak2 = fat_peak_female) + 
  scale_color_manual(labels = c("Female", "Male"), name = "Sex", values = cbPalette_dot)

#strain
slam_fig_j1 <- fcn_plotdist_smooth(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy",
...
slam_fig_j2 <- fcn_plotdist_smooth(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy", 
                        y = "bw", ylabel = "Body Weight (g)", by = "strain", peak1 = bw_peak_HET3, peak2 = bw_peak_B6) + 
  scale_color_manual(labels = c("B6", "HET3"), name = "Strain", values = cbPalette_dot)
slam_fig_j3 <- fcn_plotdist_smooth(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy", 
                        y = "fat", ylabel = "Body Fat (g)", by = "strain", peak1 = fat_peak_HET3, peak2 = fat_peak_B6) + 
  scale_color_manual(labels = c("B6", "HET3"), name = "Strain", values = cbPalette_dot)

#death
slam_fig_d1 <- fcn_plotdist_lm(metric = "gluc", x = "per_age_wk", xlabel = "Percent Life Expectancy", 
                        y = "gluc", ylabel = "Glucose (mg/dL)", by = "whendead")
slam_fig_d2 <- fcn_plotdist_lm(metric = "bw", x = "per_age_wk", xlabel = "Percent Life Expectancy",
                        y = "bw", ylabel = "Body Weight (g)", by = "whendead") 
slam_fig_d3 <- fcn_plotdist_lm(metric = "fat", x = "per_age_wk", xlabel = "Percent Life Expectancy",
...
#combine all indices
roc_gluc <- c("gluc", gluc_peak_ci, female_gluc_peak_ci, male_gluc_peak_ci, 
...
roc_bw <- c("bw", bw_peak_ci, female_bw_peak_ci, male_bw_peak_ci, 
...
roc_fat <- c("fat", fat_peak_ci, female_fat_peak_ci, male_fat_peak_ci, 
...
main_cont_surv <- main_all3 %>% select(idno, sex, strain, per_age_wk_50, per_age_wk_75, per_age_wk_90) %>% distinct() %>% inner_join(census_c16_death) 
