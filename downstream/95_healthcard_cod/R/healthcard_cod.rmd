...
# Load in input data
```{r read in censuses}
  census_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/census.csv"
  class_census_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/complete_census.csv"
  healthcard_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/SLAM Healthcard reconciled.xlsx"
  ...
  # census_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/Box-Box/metabolic-class-ITP/98_healthcard_cod/data/census.csv"
  # class_census_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/Box-Box/metabolic-class-ITP/98_healthcard_cod/data/20250426_all_cohort/complete_census.csv"
  # healthcard_path <- "/Users/JoshsMacbook2015/Library/CloudStorage/Box-Box/metabolic-class-ITP/98_healthcard_cod/data/SLAM Healthcard reconciled.xlsx"
...
```{r finalized plots}
  ...
  # Export all plots as high-quality pngs
    # Output folder (repo-relative; run with the working directory at the repo root)
    output_dir <- "98_healthcard_cod/Outputs"
...
```{r export data}
  ...
  write.csv(healthcard_final_export, "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/healthcard_final.csv", row.names = FALSE)

  # Export Fig S8A: parts-of-whole condition burden per mouse per class
  writexl::write_xlsx(bin_props_stacked_final, "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/S8A.xlsx")

  # Export Fig S8B: time-normalized incidence (HCs per year) per class
  writexl::write_xlsx(bin_props_yr_final, "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/S8B.xlsx")
  ...
  writexl::write_xlsx(
    ...
    "/Users/JoshsMacbook2015/Library/CloudStorage/OneDrive-NationalInstitutesofHealth/Trajectories_Raw_Data/pipeline_ready/98_healthcard_cod/data/Michel_raw_healthcard_3_13_26/hc_lifespan_data.xlsx"
  )
```
