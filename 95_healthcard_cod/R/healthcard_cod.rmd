...
```{r finalized plots}
  ...
  # Finalize version of S8E (cumulative incidence of HCs, all mice)
    # Columns already arrive as "Class 1"/"Class 2"/"Class 3"; the descriptor
    # recode that used to sit here was dropped so S8 labels its classes the same
