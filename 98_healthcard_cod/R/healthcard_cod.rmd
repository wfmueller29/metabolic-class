...
```{r finalized plots}
  ...
  # Export all plots as high-quality pngs
    ...
    dir.create("Healthcard_PNGs", showWarnings = FALSE)
    # Define export function
    export_plot <- function(plot_obj, filename, width = 8.5, height = 11, dpi = 1200) {
      ggsave(
        filename = file.path("Healthcard_PNGs", filename),
        plot = plot_obj,
        width = width,
        height = height,
        dpi = dpi,
    ...
    png("Healthcard_PNGs/S8E.png", width = 8.5, height = 11, units = "in", res = 1200, bg = "white")
    grid::grid.newpage()
