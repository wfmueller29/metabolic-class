...
# for fat ---------------------------------------------------------------------
bw_census_early <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_bw_og_bw_age_wk/(0, 57.50).csv")
bw_census_mid <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_bw_og_bw_age_wk/[57.50,103.50].csv")
bw_census_late <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_bw_og_bw_age_wk/[103.50,Inf).csv")

fat_census_early <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_fat_og_fat_age_wk/(0, 57.50).csv")
fat_census_mid <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_fat_og_fat_age_wk/[57.50,103.50].csv")
fat_census_late <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_fat_og_fat_age_wk/[103.50,Inf).csv")

gluc_census_early <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_gluc_og_gluc_age_wk/(0, 57.50).csv")
gluc_census_mid <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_gluc_og_gluc_age_wk/[57.50,103.50].csv")
gluc_census_late <- read.csv("../06_create_figures/output/slam_c1-c10_age_all_bwfatgluc/interval_data/slam_gluc_og_gluc_age_wk/[103.50,Inf).csv")

peek(bw_census_early)
peek(census_mid)
peek(census_late)
